...
<div class="header">
	...
	<div class="wrap-banner">
		...
		<div class="searchWrap">
			<input type="text" placeholder="어떤 상품을 찾으시나요?" onkeypress="javascript:if(event.keyCode==13){seachBar();}" id="keyword" class="searchBar" name="keyword" autocomplete="off" required="required" value="${param.keyword}">
