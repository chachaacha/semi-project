	...
	<div class="purchase_list_item">
		...
		<a href="../../product/jsp/user_buyer_product_comments.jsp?product_idx=${bl.product_idx }">
			<img alt="이미지 자리" src="../../search/image/${bl.thumbnail}">
				...
				<div class="pl_title">
				<a href="../../product/jsp/user_buyer_product_comments.jsp?product_idx=${bl.product_idx }" style="text-decoration: none; color: black;">
					<c:out value="${ bl.title }"/>
					</a>
					<%-- <a href="javascript:delPro('${ bl.product_idx }')"></a> --%>
