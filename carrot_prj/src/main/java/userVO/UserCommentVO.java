...
public class UserCommentVO {
	private int comment_idx, reply_idx,  reported_num, comment_flag, page_flag;
	...
	public UserCommentVO(int comment_idx, int reply_idx, int reported_num, int comment_flag, int page_flag, String id,
	...
	public String toString() {
		return "UserCommentVO [comment_idx=" + comment_idx + ", reply_idx=" + reply_idx + ", reported_num="
				+ reported_num + ", comment_flag=" + comment_flag + ", page_flag=" + page_flag + ", id=" + id
				+ ", product_idx=" + product_idx + ", contents=" + contents + ", new_contents=" + new_contents
				+ ", deleted=" + deleted + ", nick=" + nick + ", img=" + img + ", posted_date=" + posted_date + "]";
	}
