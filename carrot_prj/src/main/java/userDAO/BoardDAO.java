...
/*   //유저 닉네임
   ...
   public int updateTrader(BuyVO bVO) throws SQLException {
      ...
      try {
         ...
         updateTrader
         .append("   update product    ")
         .append("   set reserved='N', sold_check='Y' , buyer_id=?, purchased_date = to_date(to_char(sysdate,'yyyy-mm-dd'),'yyyy-mm-dd')   ")
         .append("   where product_idx=?    ");
         ...
         System.out.println("거래완료 완료"+updateTrader);
         System.out.println("거래완료 완료"+bVO);
   ...
   public int updateStatus(BuyVO bVO) throws SQLException {
      ...
      try {
         ...
         updateTrader
         .append("   update product    ")
         .append("   set buyer_id=null, sold_check='N', purchased_date=null ");
         ...
         System.out.println("거래완료 취소"+updateTrader);
         System.out.println("거래완료 취소"+bVO);
